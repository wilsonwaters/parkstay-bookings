        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="rounded-md bg-blue-50 p-4 border border-blue-200">
            <p className="text-sm text-blue-800">
              Your app password is encrypted and stored securely on your device. It is never sent to
          ...
          {/* Last tested info */}
          {lastTestedAt && (
            <p className="text-xs text-gray-500">Last tested: {lastTestedAt.toLocaleString()}</p>
          )}
        </form>
      )}
    </div>
