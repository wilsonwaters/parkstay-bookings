...
export function registerWatchHandlers(
  ...
  // Get watch
  ipcMain.handle(IPC_CHANNELS.WATCH_GET, async (_event: IpcMainInvokeEvent, id: number) => {
    try {
  ...
  // List watches
  ipcMain.handle(IPC_CHANNELS.WATCH_LIST, async (_event: IpcMainInvokeEvent, userId: number) => {
    try {
  ...
  // Delete watch
  ipcMain.handle(IPC_CHANNELS.WATCH_DELETE, async (_event: IpcMainInvokeEvent, id: number) => {
    try {
  ...
  // Activate watch
  ipcMain.handle(IPC_CHANNELS.WATCH_ACTIVATE, async (_event: IpcMainInvokeEvent, id: number) => {
    try {
  ...
  // Deactivate watch
  ipcMain.handle(IPC_CHANNELS.WATCH_DEACTIVATE, async (_event: IpcMainInvokeEvent, id: number) => {
    try {
  ...
  ipcMain.handle(IPC_CHANNELS.WATCH_EXECUTE, async (_event: IpcMainInvokeEvent, id: number) => {
    try {
